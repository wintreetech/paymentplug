						...
						<div className="col-md-6">
							<div className="title-two mb-60">
								...
								<h2 className="text-white">
									Track & Manage Invoices Anytime, Anywhere
								</h2>
							</div>
						</div>
						<div className="col-xl-5 col-md-6 ms-auto">
							<ul className="style-none sm-mt-60">
								<li>Seamless invoice management via web and mobile</li>
								<li>Access and monitor invoices on the go</li>
								<li>Fully customizable interface to match your brand</li>
								<li>Secure billing with enterprise-grade protection</li>
							</ul>
						</div>
					</div>
				</div>
