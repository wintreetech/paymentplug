            ...
            <div className="row align-items-center">
              <div className="col-xl-5 col-lg-6 wow fadeInLeft">
                <div className="title-one">
                  <div className="upper-title">Merchant Hub</div>
                  <h2>Simplified Merchant Management</h2>
                </div>
                <p className="text-lg mt-45 lg-mt-30 mb-35 lg-mb-20">
                  Offers a powerful partner interface to manage merchant
                  applications, monitor accounts, handle chargebacks and fraud,
                  set up accounts, and access real-time MIS reports.
                </p>
              </div>
              <div className="col-xl-7 col-lg-6 wow fadeInRight">
                <div className="media-list-item ms-auto pe-xxl-5 pe-4 ps-xxl-5 ps-4 pb-35 md-mt-60 d-flex align-items-end">
                  <ul className="style-none">
                    <li>Efficient merchant application management</li>
                    <li>Real-time risk account monitoring</li>
                    <li>Quick merchant account setup</li>
                    <li>Chargeback and fraud management</li>
                  </ul>
                </div>
              </div>
            </div>
