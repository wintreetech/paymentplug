        ...
        <div className="row">
          <div className="col-xxl-9 col-lg-8 order-lg-last">
            <div className="details-meta ps-xxl-5 ps-xl-3">
              ...
              <div className="line-wrapper pb-30 mt-60 lg-mt-40 mb-70 lg-mb-40">
                <div className="row">
                  <div className="col-md-4 wow fadeInUp">
                    <CardItem
                      icon="/assets/images/icon/icon_137.svg"
                      title="Platforms"
                  ...
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                    <CardItem
                      icon="/assets/images/icon/icon_138.svg"
                      title="Accessibility"
                  ...
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                    <CardItem
                      icon="/assets/images/icon/icon_139.svg"
                      title="Flexibility"
              ...
              <div>
                <VerticalCard
                  icon="/assets/images/icon/icon_140.svg"
                ...
                />
                <VerticalCard
                  icon="/assets/images/icon/icon_141.svg"
                ...
                />
                <VerticalCard
                  icon="/assets/images/icon/icon_142.svg"
              ...
              <div className="line-wrapper pb-30 mt-60 lg-mt-40 mb-70 lg-mb-40">
                <div className="row">
                  <div className="col-md-4 wow fadeInUp">
                    <CardItem
                      icon="/assets/images/icon/icon_143.svg"
                  ...
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                    <CardItem
                      icon="/assets/images/icon/icon_144.svg"
                  ...
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                    <CardItem
                      icon="/assets/images/icon/icon_145.svg"
              ...
              <div>
                <VerticalCard
                  icon="/assets/images/icon/icon_146.svg"
                ...
                />
                <VerticalCard
                  icon="/assets/images/icon/icon_147.svg"
                ...
                />
                <VerticalCard
                  icon="/assets/images/icon/icon_148.svg"
                  title="Branded App Publishing"
