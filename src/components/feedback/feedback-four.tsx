...
const FeedbackFour = ({ spacing }: { spacing?: string }) => {
	...
	return (
		<div
			className={`feedback-section-four ${
				spacing ? spacing : "mt-180 lg-mt-80"
			}`}
		>
			<div className="container">
				<div className="position-relative">
					...
					<p className="text-lg mt-30 lg-mt-20 mb-70 lg-mb-40">
						See how our platform transforms payment infrastructure—from startups
							...
							<div key={i} className="item">
								<div className="feedback-block-four tran3s">
									<div className="d-flex align-items-center justify-content-between">
										...
										<img
											src="/assets/images/icon/icon_48.svg"
											alt="icon"
											className="icon"
										/>
									</div>
